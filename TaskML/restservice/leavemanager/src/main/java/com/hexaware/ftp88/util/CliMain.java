...
public class CliMain {
  ...
  private void mainMenu() {
    ...
    System.out.println("6. Approve / Deny MANAGER");
  ...
  private void pendingLeaves() {
    ...
    for (LeaveDetails e : pending) {
      System.out.println(e.getLeaveId() + " " + e.getEmpId() + " "
          ...
          + e.getLeaveType() + " " + e.getLeaveStatusMgr() + " " + e.getLeaveStatusHR() + " "
          + e.getLeaveReason() + " " + e.getLeaveAppliedOn() + " " + e.getLeaveManagerComm());
    }
  }


  /**
  * For Approval and Denial by manager.
  */
  ...
  /**
  * For Approval and Denial by hr.
  */
  public static void approveDenyHR() {
    LeaveDetails leaves = new LeaveDetails();
    for (LeaveDetails e : leaves.leaveAll()) {
      System.out.println(e.getLeaveId() + " | " + e.getEmpId() + " | "
          + e.getLeaveSdate() + " | " + e.getLeaveEdate() + " | " + e.getLeaveNdays() + " | "
          + e.getLeaveType() + " | " + e.getLeaveStatusMgr() + " | " + e.getLeaveStatusHR() + " |"
          + e.getLeaveReason() + " |" + e.getLeaveAppliedOn() + " | " + e.getLeaveManagerComm());
    ...
    System.out.println("Enter Employ Id  ");
    int mgrId = sc.nextInt();
    System.out.println("Decide what you want to do (YES / NO): ");
    String ch = sc.next();
    System.out.println("HR Comments  ");
    sc.nextLine();
    String mgrCom = sc.nextLine();
    String res = LeaveDetails.approveDenyHR(leaveId, mgrId, ch, mgrCom);
    System.out.println(res);
  }
  ...
  private void applyLeave() {
    ...
    System.out.println("Enter the type of leave you want. (EL / ML): ");

...
public class Employee {
   ...
   * @param argavailableLeaveMl to set Employee's availableLeave.
   * @param argdesignation to set Employee's availableLeave.
  ...
  public Employee(final int argempId, final String argempFullName,
          ...
          final int argavailableLeave, final int argavailableLeaveMl,
          final String argdesignation, final int argmgrId) {
    this.empId = argempId;
    ...
    this.availableLeaveMl = argavailableLeaveMl;
   ...
   * @return this Employee's availableLeave.
   */
  public final int getAvailableLeaveMl() {
    return availableLeaveMl;
  }

  /**
   *
   * @param argavailableLeaveMl to set employee availableLeave.
   */
  public final void setAvailableLeaveMl(final int argavailableLeaveMl) {
    this.availableLeaveMl = argavailableLeaveMl;
  }
  ...
  /**
   *
   * @param argdesignation to set employee availableLeave.
   */
  public final void setDesignation(final String argdesignation) {
    this.designation = argdesignation;
  }
  ...
  */
  ...
  public static String decrementdddd(final int empID, final int leaveTaken) {

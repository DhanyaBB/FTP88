...
public interface EmployeeDAO  {
   ...
   */
  @SqlUpdate("UPDATE EMP_DETAILS SET AVAIL_LEAVE_BAL_EL = AVAIL_LEAVE_BAL_EL +:leavendays WHERE EMP_ID = :empid")
   ...
   * @param leavendays for leave no of days
   */
  @SqlUpdate("UPDATE EMP_DETAILS SET AVAIL_LEAVE_BAL_ML = AVAIL_LEAVE_BAL_ML +:leavendays WHERE EMP_ID = :empid")
  void incrementML(@Bind("empid") int empid, @Bind("leavendays") int leavendays);
   ...
   */
  @SqlUpdate("UPDATE EMP_DETAILS SET AVAIL_LEAVE_BAL_EL = AVAIL_LEAVE_BAL_EL -:leaveTaken WHERE EMP_ID = :empID")
   ...
   * @param leaveTaken no of days employee applied leave.
   */
  @SqlUpdate("UPDATE EMP_DETAILS SET AVAIL_LEAVE_BAL_ML = AVAIL_LEAVE_BAL_ML -:leaveTaken WHERE EMP_ID = :empID")

...
public interface LeaveDetailsDAO {
   ...
   */
  @SqlQuery("SELECT * FROM LEAVE_DETAILS WHERE LEAVE_STATUS_MGR = 'APPROVED'")
  @Mapper(LeaveDetailsMapper.class)
   ...
   * @param leaveid the id of the LeaveDetails
   */
  @SqlUpdate("UPDATE LEAVE_DETAILS SET COMMENTS = :leavemanagercomm, LEAVE_STATUS_MGR = :leavestatus WHERE "
      + "LEAVE_ID = :leaveid")
   ...
   * @param leaveid the id of the LeaveDetails
   */
  @SqlUpdate("UPDATE LEAVE_DETAILS SET COMMENTS = :leavemanagercomm, LEAVE_STATUS_HR = :leavestatus WHERE "
      + "LEAVE_ID = :leaveid")
  void commentHR(@Bind("leavemanagercomm") String leavemanagercomm, @Bind("leavestatus") String leavestatus,
      @Bind("leaveid") int leaveid);
 ...
 * @param lstatusMGR the LeaveStatus details of employee.
 * @param lstatusHR the LeaveStatus details of employee.
...
void apply(@Bind("empId") int empId,
       ...
       @Bind("leavestatusMGR") String lstatusMGR,
       @Bind("leavestatusHR") String lstatusHR,

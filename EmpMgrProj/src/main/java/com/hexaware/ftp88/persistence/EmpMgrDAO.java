...
public interface EmpMgrDAO  {
  ...
  @SqlUpdate("INSERT INTO EMPMGR(EMPNO, NAME, LOC, MGRNO) VALUES (:empno, :name, :loc, :mgrno)") 
  void insert(@Bind("empno") int empno, @Bind("name") String name, @Bind("loc") String loc, 
        @Bind("mgrno") int mgrno);
